...
export default function Example(props) {
    ...
    return (
        <Dialog open={props.edit_drawer} onClose={props.close_edit_teacher_drawer} className="relative z-10">
                            ...
                            <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                                <div className="px-4 sm:px-6 ">
                                    <div className="flex items-start justify-between">
                                        <DialogTitle className="text-base font-semibold text-gray-900">Edit teacher</DialogTitle>
                                        <div className="ml-3 flex h-7 items-center">
                                            <button
                                                type="button"
                                                onClick={props.close_edit_teacher_drawer}
                                        ...
                                        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                                            <div>
                                                ...
                                                <div className="mt-2.5">
                                                    <input
                                                        ref={props.edit_firstname}
                                                        defaultValue={props.current_teacher ? props.current_teacher.firstname : ""}
                                                        id="first-name"
                                                        name="first-name"
                                                        type="text"
                                                        placeholder={"John"}
                                                ...
                                                <div ref={props.edit_firstname_error} className="text-red-500 mx-2">
                                                    &nbsp;
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div className="mt-2.5">
                                                    <input
                                                        ref={props.edit_lastname}
                                                        defaultValue={props.current_teacher ? props.current_teacher.lastname : ""}
                                                        id="last-name"
                                                        name="last-name"
                                                        type="text"
                                                        placeholder={"Doe"}
                                                ...
                                                <div ref={props.edit_lastname_error} className="text-red-500 mx-2">
                                                    &nbsp;
                                                </div>
                                            </div>
                                                        ...
                                                        >
                                                            ...
                                                            {props.available_discipline.length > 0 ?
                                                                props.available_discipline.filter( discipline =>
                                                                    !props.badge.some(b => parseInt(b.discipline_id) == parseInt(discipline.discipline_id))
                                                                ).map((discipline) => (
                                            ...
                                            {props.badge.map((item) => (
                                                <span
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => {props.remove_badge(item.discipline_id)}}
                                                    >
